<template>
  <div
    ...
    <div
      ...
      ref="dropIndicator"
      :class="prefixCls + '-drop-indicator'"></div>
  </div>
</template>
...
import RdTreeNode from './tree-node.vue'
import emitter from '@src/mixins/emitter'
import { addClass, removeClass } from '@src/util/assist'
import { prefix } from '@src/config.js'
let prefixCls = prefix + 'tree'
export default {
  name: prefixCls,
  ...
  created() {
    ...
    this.$on('tree-node-drag-over', (event, treeNode) => {
      const dropNode = findNearestComponent(event.target, 'rdTreeNode')
