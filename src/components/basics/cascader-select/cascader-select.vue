<!-- <template>
  <div class="wrapper">cascader-select</div>
</template>
    ...
    <transition
      ...
      <div
        ...
        <rd-cascader-panel
          ...
          @close="toggleDropDownVisible(false)"></rd-cascader-panel>
        <ul
          v-if="filterable"
          v-show="filtering"
          ref="suggestionPanel"
          ...
          <slot
            v-else
            name="empty">
            <li class="el-cascader__empty-text">暂无数据</li>
          </slot>
        </ul>
      </div>
    </transition>
...
import RdCascaderPanel from './cascader-panel'
// import AriaUtils from 'element-ui/src/utils/aria-utils'
// import { t } from 'element-ui/src/locale'
// import { isEqual, isEmpty, kebabCase } from 'element-ui/src/utils/util'
import isEqual from 'lodash/isEqual'
import isEmpty from 'lodash/isEmpty'
import { isUndefined, isFunction } from '@src/util/types'
import { isDef } from '@src/util/shared'
  ...
  computed: {
    ...
    config() {
      ...
      Object.keys(MigratingProps).forEach(oldProp => {
        ...
        let oldValue = $attrs[oldProp] || $attrs[this.kebabCase(oldProp)]
