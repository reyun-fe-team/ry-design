<template>
  <main>
    <rd-table-columns-selector
      v-model="val"
      :data="columnsData"></rd-table-columns-selector>
  </main>
</template>
<script>
export default {
  data() {
    return {
      val: [
        ...
        'user2268Attribute20230811175751',
        'user2268Attribute20230811183935',
        'user2268Attribute20230811184120',
        'clickRateTkio',
        'numClick'
      ],
      columnsData: [
